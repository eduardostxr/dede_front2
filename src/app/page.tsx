...
export default function Home() {
  ...
  return (
    <main className="flex flex-col items-center mx-auto p-6 bg-gray-900">
      <img src="./logo.webp" alt="Legends" style={{ width: 240 }}
        className="d-block" />
      <div className="max-w-sm">
        <h1 className="text-3xl font-bold my-8 text-white">Admin: Legends</h1>
